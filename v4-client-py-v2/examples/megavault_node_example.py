...
async def megavault_examples():
    ...
    total_shares = await megavault.get_owner_shares(TEST_ADDRESS_3)
    print("########################################")
    print(f"Total shares at beginning: {total_shares}")
    deposit_response = await megavault.deposit(wallet, TEST_ADDRESS_3, 0, 1)
    print("\n########################################")
    print(f"Deposit response: {deposit_response}")
    await asyncio.sleep(5)
    total_shares_after_deposit = await megavault.get_owner_shares(TEST_ADDRESS_3)
    print("\n########################################")
    print(f"Total shares at after deposit: {total_shares_after_deposit}")
    withdraw_response = await megavault.withdraw(wallet, TEST_ADDRESS_3, 0, 0, 1)
    print("\n########################################")
    print(f"Withdraw response: {withdraw_response}")
    total_shares_after_withdraw = await megavault.get_owner_shares(TEST_ADDRESS_3)
    print("\n########################################")
