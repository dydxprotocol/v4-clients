...
import { GetAllCurrencyPairsRequest, GetAllCurrencyPairsResponseSDKType, GetPriceRequest, GetPriceResponseSDKType, GetPricesRequest, GetPricesResponseSDKType, GetCurrencyPairMappingRequest, GetCurrencyPairMappingResponseSDKType } from "./query";
